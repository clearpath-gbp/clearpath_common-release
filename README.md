## clearpath_common (jazzy) - 2.9.17-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy -t jazzy clearpath_common` on `Thu, 17 Sep 2026 17:12:25 -0000`
...
- rosdistro version: `2.9.16-1`
- old version: `2.9.16-2`
- new version: `2.9.17-1`
...
## clearpath_common (jazzy) - 2.9.16-2

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Wed, 09 Sep 2026 17:49:33 -0000`
...
- release repository: https://github.com/clearpath-gbp/clearpath_common-release.git
- rosdistro version: `2.9.16-1`
- old version: `2.9.16-1`
- new version: `2.9.16-2`
...
## clearpath_common (humble) - 1.3.13-1

The packages in the `clearpath_common` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_common -r humble -t humble` on `Wed, 09 Sep 2026 17:37:57 -0000`
...
- upstream repository: https://github.com/clearpathrobotics/clearpath_common.git
- release repository: https://github.com/clearpath-gbp/clearpath_common-release.git
- rosdistro version: `1.3.12-1`
- old version: `1.3.12-1`
- new version: `1.3.13-1`
...
## clearpath_common (jazzy) - 2.9.16-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Wed, 09 Sep 2026 17:24:42 -0000`
...
- upstream repository: https://github.com/clearpathrobotics/clearpath_common.git
- release repository: https://github.com/clearpath-gbp/clearpath_common-release.git
- rosdistro version: `2.9.15-1`
- old version: `2.9.15-1`
- new version: `2.9.16-1`
...
## clearpath_common (jazzy) - 2.9.15-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Tue, 18 Aug 2026 15:35:28 -0000`
...
- upstream repository: https://github.com/clearpathrobotics/clearpath_common.git
- release repository: https://github.com/clearpath-gbp/clearpath_common-release.git
- rosdistro version: `2.9.14-1`
- old version: `2.9.14-1`
- new version: `2.9.15-1`
...
## clearpath_common (humble) - 1.3.12-1

The packages in the `clearpath_common` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_common -t humble -r humble` on `Thu, 13 Aug 2026 12:43:14 -0000`
...
## clearpath_common (jazzy) - 2.9.14-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Wed, 12 Aug 2026 20:34:45 -0000`
...
- upstream repository: https://github.com/clearpathrobotics/clearpath_common.git
- release repository: https://github.com/clearpath-gbp/clearpath_common-release.git
- rosdistro version: `2.9.13-1`
- old version: `2.9.13-1`
- new version: `2.9.14-1`
...
- upstream repository: https://github.com/clearpathrobotics/clearpath_common.git
- release repository: https://github.com/clearpath-gbp/clearpath_common-release.git
- rosdistro version: `2.9.11-1`
- old version: `2.9.11-1`
- new version: `2.9.12-1`
...
## clearpath_common (jazzy) - 2.9.11-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Tue, 14 Jul 2026 15:46:38 -0000`
...
- upstream repository: https://github.com/clearpathrobotics/clearpath_common.git
- release repository: https://github.com/clearpath-gbp/clearpath_common-release.git
- rosdistro version: `2.9.10-2`
- old version: `2.9.10-2`
- new version: `2.9.11-1`
...
## clearpath_common (jazzy) - 2.9.10-2

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Thu, 02 Jul 2026 19:29:40 -0000`
...
- upstream repository: https://github.com/clearpathrobotics/clearpath_common.git
- release repository: https://github.com/clearpath-gbp/clearpath_common-release.git
- rosdistro version: `2.9.9-1`
- old version: `2.9.10-1`
- new version: `2.9.10-2`
...
## clearpath_common (jazzy) - 2.9.10-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Thu, 02 Jul 2026 19:03:51 -0000`
...
## clearpath_common (humble) - 1.3.11-1

The packages in the `clearpath_common` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_common -r humble -t humble` on `Tue, 02 Jun 2026 19:45:39 -0000`
...
## clearpath_common (jazzy) - 2.9.9-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Tue, 02 Jun 2026 19:36:12 -0000`
...
## clearpath_common (jazzy) - 2.9.8-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Thu, 28 May 2026 13:27:30 -0000`
...
## clearpath_common (jazzy) - 2.9.7-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Fri, 22 May 2026 03:20:52 -0000`
...
## clearpath_common (jazzy) - 2.9.6-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Wed, 15 Apr 2026 01:51:51 -0000`
...
## clearpath_common (humble) - 1.3.10-1

The packages in the `clearpath_common` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_common -r humble -t humble` on `Wed, 15 Apr 2026 01:33:30 -0000`
...
## clearpath_common (jazzy) - 2.9.5-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy -t jazzy clearpath_common` on `Wed, 25 Mar 2026 15:51:40 -0000`
...
## clearpath_common (jazzy) - 2.9.4-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Fri, 13 Mar 2026 16:51:06 -0000`
...
## clearpath_common (jazzy) - 2.9.3-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Thu, 26 Feb 2026 22:58:41 -0000`
...
## clearpath_common (jazzy) - 2.9.2-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Thu, 26 Feb 2026 19:13:44 -0000`
...
## clearpath_common (jazzy) - 2.9.1-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Thu, 12 Feb 2026 02:32:18 -0000`
...
## clearpath_common (humble) - 1.3.9-1

The packages in the `clearpath_common` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_common -r humble -t humble` on `Fri, 30 Jan 2026 20:18:25 -0000`
...
## clearpath_common (jazzy) - 2.8.5-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Fri, 30 Jan 2026 19:59:52 -0000`
...
## clearpath_common (jazzy) - 2.8.4-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -t jazzy -r jazzy` on `Mon, 22 Dec 2025 19:15:13 -0000`
...
## clearpath_common (jazzy) - 2.8.3-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Tue, 16 Dec 2025 15:31:24 -0000`
...
## clearpath_common (humble) - 1.3.8-1

The packages in the `clearpath_common` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_common -r humble -t humble` on `Tue, 16 Dec 2025 15:00:49 -0000`
...
## clearpath_common (jazzy) - 2.8.2-2

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Thu, 06 Nov 2025 16:49:21 -0000`
...
## clearpath_common (jazzy) - 2.8.2-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Thu, 06 Nov 2025 16:26:38 -0000`
...
## clearpath_common (jazzy) - 2.8.1-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Tue, 28 Oct 2025 18:38:32 -0000`
...
## clearpath_common (jazzy) - 2.8.0-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Thu, 23 Oct 2025 18:13:42 -0000`
...
## clearpath_common (jazzy) - 2.7.4-1

The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy -y` on `Thu, 18 Sep 2025 19:54:01 -0000`
...
## clearpath_common (humble) - 1.3.7-1

The packages in the `clearpath_common` repository were released into the `humble` distro by running `/usr/bin/bloom-release clearpath_common -r humble -t humble -y` on `Thu, 18 Sep 2025 19:39:54 -0000`
...
## clearpath_common (jazzy) - 2.7.3-1
...
The packages in the `clearpath_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release clearpath_common -r jazzy -t jazzy` on `Thu, 29 May 2025 21:28:18 -0000`
